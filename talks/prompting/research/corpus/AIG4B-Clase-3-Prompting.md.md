...
18. **[11] "Fable 5" no corresponde a ningún modelo Anthropic conocido.** Aparece en el tarifario ($10/$50) y en la captura de pantalla de la slide 11, donde figura como *"Currently unavailable"*. La captura, además, muestra una lista de modelos (Opus 4.8, Opus 4.7, Opus 4.6, Opus 3, Sonnet 4.6, Haiku 4.5) que no coincide con la tabla de la misma slide.
