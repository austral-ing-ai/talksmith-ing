...
- [closed] 2026-08-12 — "hay muchos conectores mcp mas alla de github y railway para desarrollo"
  Resolution: La seccion 6 se reescribio: la lamina 6.3 dejo de ser "los dos de la mision" y paso a ser el ecosistema MCP para desarrollo (bases de datos, browsers, observabilidad, gestion, diseño, docs, infra), con GitHub y Railway como dos ejemplos mas; los detalles de esos dos se movieron a la seccion 7 de la mision. El Thesis y el Narrative arc se reescribieron en el mismo sentido.
- [closed] 2026-08-12 — (chat) "la presentacion esta girando en torno a la mision; estamos explicando conceptos que van mucho mas alla de recibir un repo con codigo heredado"
  Resolution: La mision se descentro de las secciones 1 a 6: los ejemplos anclados a Corta se generalizaron (CLAUDE.md de ejemplo, Skill de ejemplo, guiños en speaker notes), las referencias al "paso 0 de la mision" salieron de la teoria, y toda la especificidad de la mision quedo contenida en la seccion 7.
---
...
- [closed] 2026-08-12 — (chat) "en la lamina del CLAUDE.md de ejemplo el texto explicativo de la izquierda esta muy chico"
  Resolution: El codigo del ejemplo se recorto de 17 a 13 lineas y la explicacion de 3 a 2 items para que el ajuste de contenido no achique la tipografia; el detalle recortado quedo en speaker notes.
- [closed] 2026-08-12 — (chat) "en la lamina del subagente por dentro, cada campo del frontmatter (name, description, tools) con un color distinto"
  Resolution: Post-proceso deterministico del render HTML (documentado en memory.md): la linea de name en rojo, description en azul, tools en verde dentro del codebox de esa lamina.
- [closed] 2026-08-12 — (chat) "en donde buscar servidores MCP no se mencionan las bibliotecas oficiales de Claude/ChatGPT"
  Resolution: Dos filas nuevas al tope de la tabla de 6.4 (directorio de conectores de Claude y apps/conectores de ChatGPT) y speaker notes reordenadas: primero las fuentes oficiales, despues las comunitarias. URLs pendientes de verificacion en Open questions.
- [closed] 2026-08-12 — (chat) "cambia Conclusions por Conclusiones"
  Resolution: Seccion renombrada en el H1, la agenda y el arco; el modelo del deck usa "Conclusiones".
- [closed] 2026-08-12 — (chat) "'Lo que se llevan: cambio el rol' es AI slop puro"
  Resolution: Lamina retitulada "El nuevo rol: Diseñar, delegar y revisar" y el primer card paso a "El nuevo rol"; el patron "Lo que se llevan / key takeaways" se propuso como regla propia de desrobotizar.
- [closed] 2026-08-12 — (chat) "en la lamina 'Que es MCP' los textos descriptivos de las componentes estan demasiado chicos e ilegibles"
  Resolution: Los tres bullets de 6.1 se acortaron (el detalle paso a speaker notes) para que el ajuste de contenido no achique la tipografia junto al diagrama.
- [closed] 2026-08-12 — (chat) "'hacerle leer las specs al agente' en el paso 0 confunde: la premisa es que NO hay specs escritas de Corta; hacer SPEC.md es parte del ejercicio"
  Resolution: En mision y deck, lo que se lee en el paso 0 ahora se llama "documentacion de los MCP servers" (tambien en 6.2); la 7.1 suma el bullet de la premisa (Corta sin specs escritas, escribir SPEC.md es parte del ejercicio) y la 7.2 el bullet de la forma de trabajo (SPEC.md + TDD), que la mision pide como practica obligatoria.
...
- [closed] 2026-08-12 — ""quiero que toque el mundo" es AI slop"
  Resolution: La etiqueta del bloque MCP paso a "quiero que use GitHub, la base de datos, el deploy"; en las speaker notes, "MCP para que toque el mundo exterior" paso a "MCP para las herramientas externas".
- [closed] 2026-08-12 — ""cada tarea usa solo las que necesita" es AI slop e innecesario"
  Resolution: La frase se corto de la linea de idea clave, del pie del diagrama (que quedo sin pie) y del bullet de Conclusions 1 donde se repetia.
---
...
- [closed] 2026-08-12 — (chat) "agrega un par de diapositivas sobre los archivos .md, mencionando que la memoria, las especificaciones y el conocimiento en general se debe guardar en ese formato"
  Resolution: Dos laminas nuevas en la seccion 2: 2.3 "Markdown, el formato del ecosistema" (todas las piezas son .md con frontmatter; entra en diffs y PRs como el codigo) y 2.4 "El conocimiento del proyecto en .md" (la regla: memoria, especificaciones y conocimiento en .md dentro del repo; sobrevive a la conversacion). La lamina de iterar paso a 2.5 y el Goal de la seccion se actualizo.
- [closed] 2026-08-12 — (chat) "'Todas las piezas son Markdown' es mentira y puede malinterpretarse; cambiar por 'El cerebro en Markdown'"
  Resolution: El primer bullet de 2.3 paso a "El cerebro en Markdown: el contrato, las Skills y los subagentes son archivos .md".
- [closed] 2026-08-12 — (chat) "'El conocimiento del proyecto, en .md': sacar la coma (fragmento telegrafico, AI slop)"
  Resolution: Titulo de 2.4 sin coma; el patron ya estaba en las reglas propias de desrobotizar y se agrego este caso como ejemplo de titulo.
- [closed] 2026-08-12 — (chat) "el diff no es LA unidad de revision: principalmente lo son los tests; aconsejar fuerte TDD con bateria grande derivada de SPEC.md, y hablar de SPEC.md"
  Resolution: La lamina de iterar (ahora 2.6) se reescribio con los tests como unidad de revision principal y TDD derivado de SPEC.md; la 2.4 define SPEC.md en el item de especificaciones; la mision suma la seccion "La forma de trabajo: SPEC.md y TDD".
- [closed] 2026-08-12 — (chat) "hablar de manejo de contexto: ventana finita, /compact, contexto > prompting, ventaja y desventaja de la ventana grande"
  Resolution: Lamina nueva 2.5 "El manejo del contexto"; iterar paso a 2.6; la seccion quedo en seis laminas.
...
- [closed] 2026-08-12 — "se le pide al agente que lo genere leyendo el repo y las instrucciones explicitas del usuario a medida que va pasando la conversacion, es importante decir la mayor posible desde el principio y pedirle a Claude/Codex que vaya recolectando las preferencias e instrucciones del usuario en el CLAUDE.md"
  Resolution: El remate de la lamina se reescribio con las dos fuentes (el repo + las instrucciones del usuario durante la conversacion) y las dos practicas (decir lo mas posible desde el principio; pedirle al agente que recolecte preferencias en el CLAUDE.md); las speaker notes desarrollan ambas.
...
- [closed] 2026-08-12 — (chat) "a la mision agregarle una skill /collect-memory que actualice la memoria y las instrucciones del agente en funcion de los avances de la conversacion y las preferencias expresadas por el usuario"
  Resolution: Nuevo extra "la memoria del agente" en missions/clase2/mission.md (crear la Skill /collect-memory, usarla al cierre de cada sesion, criterio de exito con el diff de CLAUDE.md); la lamina 7.2 suma el bullet del extra, la placa dice "extras: equipo · memoria del agente" y las speaker notes lo conectan con las secciones 3 y 4.
