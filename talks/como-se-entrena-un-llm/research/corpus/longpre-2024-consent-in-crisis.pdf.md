---
source_file: longpre-2024-consent-in-crisis.pdf
source_type: article
...
## Provenance
- Original location: articles/longpre-2024-consent-in-crisis.pdf
- Format: pdf (41 pages)
- Author / source (if known): Shayne Longpre, Robert Mahari, Ariel Lee, Campbell Lund (team leads); Hamidah Oderinwale, William Brannon, Nayan Saxena, Naana Obeng-Marnu, Tobin South, Cole Hunter, Kevin Klyman, Christopher Klamm, Hailey Schoelkopf, Nikhil Singh, Manuel Cherep (top contributors); 30 alphabetized contributors (Ahmad Mustafa Anis … Yizhi Li); advisors Caiming Xiong, Luis Villa, Stella Biderman, Hanlin Li, Daphne Ippolito, Sara Hooker, Jad Kabbara, Sandy Pentland. Conducted by the Data Provenance Initiative (supported by the Mozilla Data Futures Lab Infrastructure Fund). Correspondence: data.provenance.init@gmail.com. Annotations released at https://github.com/Data-Provenance-Initiative/Data-Provenance-Collection. Venue not printed in the extracted text (arXiv preprint).
- Date of original (if known): arXiv:2407.14933v2 [cs.CL] 24 Jul 2024. Data window: Wayback Machine snapshots monthly from January 2016 to April 2024; forecasts to April 2025; WildChat logs April 9, 2023 – May 1, 2024.
- arXiv: 2407.14933v2
...
## Key claims
- General-purpose AI "systems are built on massive swathes of public web data, assembled into corpora such as C4, RefinedWeb, and Dolma"; the paper claims "the first, large-scale, longitudinal audit of the consent protocols for the web domains underlying AI training corpora", covering 14,000 web domains.
- The web is "the primary communal source of data, or 'data commons', for general-purpose and multi-modal AI systems".
- Headline (abstract): "in a single year (2023-2024) there has been a rapid crescendo of data restrictions from web sources, rendering ~5%+ of all tokens in C4, or 28%+ of the most actively maintained, critical sources in C4, fully restricted from use. For Terms of Service crawling restrictions, a full 45% of C4 is now restricted."
...
- The Robots Exclusion Protocol (robots.txt), "first introduced in 1995 and codified in 2022", was "not designed with AI in mind"; it is "not legally enforceable" but "respected by all major search engines".
- Symptoms of "ineffective web protocols, not designed to cope with the widespread re-purposing of the internet for AI": proliferation of AI-specific clauses, asymmetries between AI developers, inconsistencies between Terms of Service and robots.txt.
- Adoption: since 2016, the share of HEAD_C4 domains without a robots.txt and without Terms of Service has gone from 20% and 80% respectively "to near zero".
- "Robots.txt crawling restrictions have risen precipitously since mid-2023", "directly after the introduction of GPTBot and Google-Extended crawler agents"; the shift to full restrictions mainly comes from sites with previously moderate restrictions.
- Across the entire corpora ~1% of C4, RefinedWeb and Dolma tokens were restricted in mid-2023 vs 5-7% in April 2024; in the head (HEAD_All) 20-33% of tokens are restricted vs <3% one year prior; relative rise 500%+ (full corpus, C4 and RefinedWeb) and 1000%+ (head). These count only fully restricted domains.
- AI developers are restricted to very different degrees in HEAD_C4 (April 2024): OpenAI 25.9%, Anthropic 13.3%, Common Crawl 13.3%, Google's AI crawler (Google-Extended) 9.8%, False Anthropic 6.0%, Cohere 4.9%, Meta 4.1%, Internet Archive 3.2%, Google Search 1.0%. These asymmetries "tend to advantage less widely known AI developers".
- Terms of Service: gradual shift to anti-crawling and, "only in 2024", explicit anti-generative-AI terms; 26-53% relative increase in ToS crawling restrictions in the last year; 45-55% of all tokens in the three corpora have "a form of data use restriction in their Terms pages". "In practice, most automatic crawlers do not heed these Terms".
- Restrictions are driven by news, forums and social media: nearly 45% of News website tokens in HEAD_All are fully restricted by robots.txt, vs 3% in 2023; crawls that respect robots.txt may shift "away from news, social media, and forums, and towards organization and e-commerce websites."
- SARIMA forecasts: by April 2025 an additional absolute 2-4% of full-corpus tokens (7-11% of head tokens) fully restricted by robots.txt; ToS-restricted tokens in the full corpus up an absolute 6-10%. These trends "will severely hamper the data scaling practices in the coming years—which have thus forth been responsible for the remarkable capability improvements."
- Inconsistent signalling: conditional on any AI org being restricted, OpenAI is restricted 91.5% of the time, Common Crawl and Anthropic 83.4%, Google-Extended 72.0%, False Anthropic 61.6%, Cohere 52.3%, Meta 52.2%, Internet Archive 32.3%, Google Search 17.1% — omissions suggest administrators are unaware of the full list of AI agents; high omission of Internet Archive and Google Search suggests openness to archiving and search.
- Unrecognized agents: 4.5% of websites disallowed ANTHROPIC-AI or CLAUDE-WEB but not CLAUDEBOT, Anthropic's documented agent; "Anthropic reports no ownership of these."
- Contradictions between robots.txt and ToS: many sites write anti-crawling terms but have no robots.txt (35.1%), or have no ToS but a restrictive robots.txt (20.3%); non-commercial-only terms paired with restrictive robots.txt may "unintentionally limit academic web crawlers".
- Head vs tail: HEAD_All is mostly news, social media/forums and encyclopedias (72.9%); the random tail is dominated by personal/organization websites, blogs and e-commerce (97%). Head domains are more monetized (ads +47.5%, paywalls +24.1%), more restricted (robots.txt +22.5%, ToS +35.3%), and more multimodal (image +4.4%, video +39.8%, audio +38.4%); user-generated and sensitive content differ less.
- "Crawlers that respect the restrictions ... will increasingly lose access to the most multi-modal, highly curated, and up-to-date content sources."
- Misalignment with real use (WildChat, 1M ChatGPT conversations): "in over 30% of conversations, users request creative compositions such as fictional story writing or continuation, role-playing, or poetry. However, creative writing is poorly represented among the web data used for model training."
- "Language models trained only on web data are known to struggle to understand the structure of discourse and underperform models trained with instruction finetuning and preference training on highly curated data".
- Sexual content: sensitive content is "< 1% of the web domains in HEAD_C4" but "sexual role-play represents 12% of all recorded user interactions in WildChat"; OpenAI's models "are further trained to refuse requests that violate OpenAI's Usage Policies".
- News is nearly 40% of tokens in HEAD_C4 but "fewer than 1% of ChatGPT queries appear to be related to news or current affairs" — relevant to the fair-use "effect on the potential market" factor (17 U.S.C §107), though the authors "caution against over-interpreting these results to suggest a stronger case for fair use".
- Circumvention: "multiple AI developers have been accused of bypassing robots.txt opt-outs"; AI systems "may be distinguishing between crawling data for training, and crawling data to retrieve information for user questions at inference time" (OpenAI: GPTBot for training, ChatGPT-User for live browsing).
- Proposed fix: a protocol that controls "how their webpages are used rather than who can use them" (e.g., only for search, only for non-commercial AI, only for AI that attributes outputs), plus extended restriction periods.
- Collateral damage: sites blanket-block with "*" or block non-profit archives (Common Crawl, Internet Archive) to stop AI training, hurting academic and non-commercial uses; Common Crawl is "cited in 10,000+ research articles"; academic and non-commercial interests are "secondary victims".
- Economic fears: small content providers may "opt out of the web entirely, or move to posting on walled" sites; expect "more websites locking their data behind login or paywalls to prevent it being trained on".
- Ethics: robots.txt/ToS owners are "often imperfect proxies for the actual copyright holders"; the authors "do not prescribe legal or ethical answers".

## Definitions and terminology
- **Data commons** — the web as "the primary communal source of data" for general-purpose AI.
- **Web crawler** — "automatic bots that systematically explore the internet and record what they see"; agents that retrieve pages without human intervention.
- **Robots Exclusion Protocol (REP) / robots.txt** — machine-readable file telling crawlers what may be crawled; introduced 1995, codified 2022 (RFC 9309); instructions can target all crawlers ("*") or specific user agents (e.g., "Googlebot", "CCBot").
- **Terms of Service (ToS)** — "a legal agreement between the website and users of the site"; richer, natural-language, but lacks practical deterrence without robots.txt.
- **AI Organizations** — the audited set: Google, OpenAI, Anthropic, Cohere, Meta (AI developers) plus Common Crawl and the Internet Archive (non-profit archives whose data is taken for AI training).
- **Restricted tokens (robots.txt)** — "the portion of tokens from web domains that fully restrict one or more of the AI Organizations's crawlers."
- **Restricted tokens (ToS)** — "the portion of unusable tokens due to terms that preclude crawling or AI."
- **HEAD_All** — union (3.95k) of the top 2k domains by token count from each of C4, RefinedWeb, Dolma: "the largest, most actively maintained, and critical domains for AI training". **HEAD_C4** — the C4 head only.
- **RANDOM10k / RANDOM2k** — 10k domains randomly sampled from the intersection of the three corpora (10,136,147 domains); 2k subset human-annotated. May "skew towards more widely-used or high-quality domains".
- **Robots.txt restriction taxonomy (ascending)** — 1 no robots.txt; 2 no restrictions ("User-agent: * / Disallow:"); 3 only sitemap; 4 sitemap + crawl delay; 5 search/query restrictions (e.g., "Disallow: /search", "Disallow: /*?*"); 6 specific directories prohibited; 7 agent fully disallowed.
- **ToS taxonomies** — Competing services: Non-Compete, No Re-Distribution, both, No restrictions. License type: Personal/Noncommercial/Research Only, Conditional Commercial Access, Open or Unrestricted Commercial Use. Crawling & AI: prohibits crawling and AI; prohibits crawling only; prohibits AI only; conditional; no restrictions.
- **Non-Compete** — ToS clause prohibiting use of content "for competing services".
- **False Anthropic** — unrecognized user agents "anthropic-ai" and "Claude-Web" used in robots.txt, not documented by Anthropic.
- **User agents (Table 5)** — GPTBot (OpenAI training), ChatGPT-User (OpenAI retrieval for live browsing), Google-Extended (Google, "Gemini Apps, Vertex AI generative APIs, and future generations of models"), Googlebot (search), CCBot (Common Crawl archive), ClaudeBot (Anthropic training/retrieval), FacebookBot (Meta), cohere-ai (unofficial), ia_archiver (Internet Archive).
- **SARIMA** — Seasonal Autoregressive Integrated Moving Average model used for forecasting; selected via pmdarima auto.arima optimizing AIC; reported orders (2, 1, 2) non-seasonal and (1, 1, 1, 6) seasonal.
- **WildChat** — "a recent set of 1 million user conversations with ChatGPT", collected through a HuggingFace Space wrapper around OpenAI services.
- **WildChat service categories** — Creative Composition, Academic Composition, Coding composition, Brainstorming/planning, Explanation & Reasoning, Self-help, Sexual content, News, E-commerce Information, Translation, Organization Information (plus General information).
- **Four-factor fair use analysis** — one factor evaluates how the use "affects the potential market for the original work (see 17 U.S.C §107)".

## Evidence and examples
- **Table 1** (audited sources; garbled layout) — C4: crawl 4/2019, 15,928,138 web domains; RefinedWeb: 2008 to 2/2023, 33,210,738; Dolma: 5/2020 to 6/2023, 45,246,789; intersection 10,136,147. Each has "100k-1M+ downloads".
- **Table 2** — attributes collected per domain: content modalities, user content, sensitive content, paywall, advertisements, purpose & service, robots.txt, terms & policies, crawling & AI policy, content use policy, non-compete policy.
- **Figure 1** — HEAD_C4 2016–April 2024 (+1-year forecast): robots.txt restriction categories with markers for G-Ext., GPTBot, GPT-4, ChatGPT launches (and GDPR effective/adoption for ToS); ToS categories (No Crawling & AI, No Crawling, No AI, Conditional Use, Non-Commercial Use, Non-Compete, No Re-Distribution, Unrestricted Use, No Terms Pages); per-organization restriction rates (OpenAI 25.9%, Anthropic 13.3%, Common Crawl 13.3%, Google 9.8%, False Anthropic 6.0%, Cohere 4.9%, Meta 4.1%, Internet Archive 3.2%, Google Search 1.0%).
- **Figure 2** — restricted tokens over time for Full Corpus vs HEAD_All, by corpus (C4, Dolma, RefinedWeb) and by domain type (Acad, E-comm, Encyc, Gov, News, Org/Pers, Socials/Forum); unevenness due to Wayback gaps.
- **Figure 3** — cross-tabulation of ToS policies vs robots.txt restrictions for HEAD_C4 (% tokens); the two mechanisms "frequently disagree, both in what they express, and can express" (cell values garbled in extraction, e.g. 34.9% none/none-ish cells, 8.6%, 12.4%).
- **Table 3** — % each org's crawler is restricted if at least one other org is restricted: OpenAI 91.5, Common Crawl 83.4, Anthropic 83.4, Google-Extended 72.0, False Anthropic 61.6, Cohere 52.3, Meta 52.2, Internet Archive 32.3, Google Search 17.1.
- **Table 4** — mean incidence rates (Top 100 / Top 500 / Top 2000 / Random / Diff): Restrictive robots.txt 38.4 / 35.0 / 26.5 / 3.4 / +23.1; Restrictive Terms 64.1 / 61.0 / 51.2 / 15.7 / +35.5; User Content 21.3 / 19.1 / 19.4 / 15.1 / +4.4; Paywall 31.8 / 31.3 / 24.6 / 1.6 / +23.0; Ads 54.6 / 61.4 / 53.2 / 5.4 / +47.9; Image 96.8 / 97.0 / 96.7 / 95.0 / +1.7; Video 87.0 / 78.8 / 58.7 / 18.9 / +39.8; Audio 80.7 / 68.3 / 41.8 / 3.4 / +38.4; Sensitive 0.0 / 0.4 / 1.1 / 0.6 / +0.5. Token-weighted corpus estimates: restrictive robots.txt C4 5.0±1.5, RW 6.6±2.3, Dolma 5.6±1.9; restrictive Terms C4 43.2±15.2, RW 52.8±30.3, Dolma 52.3±15.4. Service shares (Top 100/500/2000/Random): News 45.6 / 53.3 / 50.0 / 5.3; Encyclopedia 20.5 / 13.2 / 11.1 / 0.4; Social Media/Forums 9.4 / 9.3 / 11.8 / 1.6; Org/Personal 15.3 / 13.2 / 12.7 / 71.2.
- **Figure 4** — (a) HEAD_C4 token share by service and monetization (News largest, ~40%); (b) estimated % of WildChat queries by category (Creative Composition largest >30%, Sexual Content ~12%, News <1%).
- **Robots.txt restriction contradiction stats** — 35.1% of sites with anti-crawling terms have no robots.txt; 20.3% have no ToS but a restrictive robots.txt.
- **Table 5** — organizations and user agents with purposes (Training / Retrieval / Web Search / Archive).
- **Table 6** — observations of ~41 listed agents across robots.txt of 14k domains (e.g., "*" 226,903 observations; GPTBot not separately visible in the extracted rows; ChatGPT-User 895, anthropic-ai 260, cohere-ai 185, Google-Extended 871, FacebookBot 235, ClaudeBot 45, Claude-Web 89; ChatGPT-User fully disallowed 83.80%, Google-Extended 95.98%, ClaudeBot 88.89%).
- **Figure 5** — conditional restriction matrix between organizations (OpenAI nearly always disallowed if any AI org is; reciprocal less frequent).
- **Annotation** — 14 crowdworkers from six countries (Pakistan 8, Bangladesh 2, Vietnam 1, Philippines 1, USA 1, Germany 1); $6,972 for 14,228 rows; ~$25–$30/hour.
- **GPT-4o ToS classification** — prompts return {"verdict": n, "evidence": "..."}; micro-averaged precision/recall vs 100-URL gold sets: Competing Services 0.92, License Type 0.85, Crawling and AI Policy 0.89. Example prompt format: `{"verdict": 5, "evidence": "N/A"}`.
- **WildChat labelling** — 100 conversations manually clustered to build taxonomy; 1k labelled by GPT-4o; manual check of 50 gave an 18% error rate; system prompt "You are a categorization assistant. ... classify the prompt into one or more of the following 'Type of Service' categories" returning {"Type of Service": []}.
- **External web audits cited** — Pew: 38% of webpages existing in 2013 no longer accessible a decade later; Originality.ai: of top 1000 websites almost 35% block GPTBot vs 12.5% Google-Extended; news survey: more than 53% of 1,164 news publishers block GPTBot vs 41.3% Google-Extended.
- **Legal example** — ToS enforcement footnote: Bogard v. TikTok Inc., No. 3:23-cv-00012-RLY_MJD, 2024 WL 1588423 (S.D. Ind. Mar. 24, 2024).
- **Wayback Machine** — "a digital archive of 835 billion web pages"; Common Crawl "has collected and stored hundreds of billions of web pages since 2008".

## Inconsistencies / open questions
- [verified] Head-restriction figure varies across sections: abstract "28%+ of the most actively maintained, critical sources in C4"; Introduction "~25%+ of tokens from the most critical domains"; §3.1 "20-33% of all tokens" in HEAD_All — same source, different framings/aggregates.
- [verified] ToS figure framed differently: abstract says "For Terms of Service crawling restrictions, a full 45% of C4 is now restricted", while §3.1 says "45-55% of all tokens in these three corpora have a form of data use restriction in their Terms pages" and Table 4 gives C4 restrictive Terms 43.2±15.2 — "crawling restrictions" vs "a form of data use restriction" are not the same category.
- [verified] §3.3 prose differences do not match the Table 4 "Diff" column: text says ads +47.5%, paywalls +24.1%, robots.txt +22.5%, ToS +35.3%; Table 4 shows +47.9, +23.0, +23.1, +35.5 — checked in the verbatim text.
- [verified] §3.1 says "Paired with the findings in Table 2" for domain composition, but Table 2 is the attribute list; the composition data are in Table 4 — likely a reference error.
- [verified] Table 6 caption says "top 60 web crawler agents", but only ~41 agent rows appear in the extracted table.
- [verified] Forecasting: Table 8 reports SARIMA orders (2, 1, 2) and seasonal (1, 1, 1, 6), but Table 9 coefficients list only ar.L1/ma.L1 and seasonal lags S.L2 (C4), S.L6 (Dolma), S.L16 (RefinedWeb) — the fitted models appear not to match the stated specification.
- [verified] Typos/garbling: "in on year (2023-04 to 2024-04)"; "mico-average"; "preforming"; "thouroughly"; "statest"; "It's scale"; Table 1, Figure 3 and Figure 5 values flattened and partly unreadable in the extraction; small-caps names render as "H EADAll", "H EADC4", "R ANDOM10k", "C LAUDE B OT" (normalized to HEAD_All, HEAD_C4, RANDOM10k, CLAUDEBOT in the curated sections and excerpts).
- [verified] Author-stated caveats: "We make no assertion regarding whether the prior omission of a robots.txt or restrictions implies consent"; footnote: values for missing robots.txt/ToS "may be slightly high ... due to gaps in the Wayback Machine"; measurements "only capture full restricted domains".
- [verified] Author-stated WildChat limitations: may not be representative; single ChatGPT instance; hosted on HuggingFace Spaces (more technical user base); April 9, 2023 – May 1, 2024 with GPT-3.5-Turbo and GPT-4; coarse manual taxonomy; News content may feed "General Information" answers; GPT-4o labels had an 18% error rate on a 50-prompt check.
- [verified] Author-stated sampling bias: RANDOM10k drawn from the intersection of the three corpora "may skew towards more widely-used or high-quality domains".
- [verified] The authors explicitly "caution against over-interpreting" the use-mismatch as support for fair use.
- [verified] ToS categorization was automated with GPT-4o (precision/recall 0.85–0.92), so ToS figures carry classifier error.
- [open question] All restriction levels are as of April 2024 and forecasts target April 2025 — whether the forecast materialized requires a later audit (e.g., newer Data Provenance Initiative releases).
- [open question] Claims that AI developers bypass robots.txt are reported from press (Reuters, WIRED) and are "not possible to confirm" per the authors — settled only by independent evidence.
- [open question] The "nearly 40%" News share of HEAD_C4 tokens (§3.4) vs Table 4 News shares of 45.6–53.3% (averaged across corpora) — different samples; the per-corpus C4 figure in Figure 4 would settle it.
- [open question] Whether respecting these restrictions actually changes model capability/scaling ("will severely hamper the data scaling practices") is argued, not measured — would be settled by training experiments on restricted vs unrestricted data.

## Images / diagrams
### `longpre-2024-consent-in-crisis.pdf/images/fig-01-p005.png`
- Provenance: Figure 1 of `articles/longpre-2024-consent-in-crisis.pdf`, page 5, vector figure; cropped from the page with PyMuPDF (graphics bbox + labels + caption), rendered at 160 dpi, 912x1003 px. Replaces the earlier whole-page render `page-005-figures.png`.
- Depiction: <!-- pending: process_images -->
- Why it matters: <!-- pending: process_images -->
- Transcribed text: <!-- pending: process_images -->

### `longpre-2024-consent-in-crisis.pdf/images/fig-02-p006.png`
- Provenance: Figure 2 of `articles/longpre-2024-consent-in-crisis.pdf`, page 6, vector figure; cropped from the page with PyMuPDF (graphics bbox + labels + caption), rendered at 160 dpi, 909x734 px. Replaces the earlier whole-page render `page-006-figures.png`.
- Depiction: <!-- pending: process_images -->
- Why it matters: <!-- pending: process_images -->
- Transcribed text: <!-- pending: process_images -->

### `longpre-2024-consent-in-crisis.pdf/images/fig-03-p007.png`
- Provenance: Figure 3 of `articles/longpre-2024-consent-in-crisis.pdf`, page 7, vector figure; cropped from the page with PyMuPDF (graphics bbox + labels + caption), rendered at 160 dpi, 911x410 px. Replaces the earlier whole-page render `page-007-figures.png`.
- Depiction: <!-- pending: process_images -->
- Why it matters: <!-- pending: process_images -->
- Transcribed text: <!-- pending: process_images -->

### `longpre-2024-consent-in-crisis.pdf/images/fig-04-p010.png`
- Provenance: Figure 4 of `articles/longpre-2024-consent-in-crisis.pdf`, page 10, vector figure; cropped from the page with PyMuPDF (graphics bbox + labels + caption), rendered at 160 dpi, 908x412 px. Replaces the earlier whole-page render `page-010-figures.png`.
- Depiction: <!-- pending: process_images -->
- Why it matters: <!-- pending: process_images -->
- Transcribed text: <!-- pending: process_images -->

### `longpre-2024-consent-in-crisis.pdf/images/fig-05-p033.png`
- Provenance: Figure 5 of `articles/longpre-2024-consent-in-crisis.pdf`, page 33, vector figure; cropped from the page with PyMuPDF (graphics bbox + labels + caption), rendered at 160 dpi, 913x1127 px. Replaces the earlier whole-page render `page-033-figures.png`.
- Depiction: <!-- pending: process_images -->
- Why it matters: <!-- pending: process_images -->
- Transcribed text: <!-- pending: process_images -->
...
> 1. A proliferation of restrictions on the AI data commons. We find a rapid proliferation of restrictions on web crawlers associated with AI development in both websites' robots.txt and Terms of Service. We estimate, in on year (2023-04 to 2024-04), ~25%+ of tokens from the most critical domains, and ~5%+ of tokens from the entire corpora of C4, RefinedWeb, and Dolma have since become restricted by robots.txt. Forecasting these trends forward shows a decline in unrestricted, open web data year-over-year.
...
> 3. A divergence in content characteristics between the head and tail of public web-crawled training corpora. We find the largest web-based sources of public training corpora have significantly higher rates of user content, multi-modal content, and monetized content, but only slightly less sensitive/explicit content. Top web domains comprise news, encyclopedias, and social media sites, as compared to the many organization websites, blogs, and ecommerce websites in the long tail of web sources.
> 4. A mismatch between web data and common uses of conversational AI. We contrast data web sources with the real-world usage of conversational AI—showing how substantial portions of web-derived training data may be misaligned with the tasks that AI models are actually used for. These results may have implications for model alignment, future data collection practices, and copyright.

— §1 Introduction, key findings

> The REP, first introduced in 1995 and codified in 2022, has become the default mechanism for website owners to indicate to web crawlers what parts of their website, if any, they consent to have crawled [54]. While it is not legally enforceable, it is respected by all major search engines, as it prevents website servers from getting overloaded by crawlers, it allows websites to signal pages that are undesirable to crawl (for example, calendar sites that could lead to infinite loops), and by respecting it, crawlers disincentivize adversarial tactics designed to impede crawlers.

— §2 Methodology

> Robots.txt crawling restrictions have risen precipitously since mid-2023. Figure 1(Top) shows the rapid re-distribution of robots.txt restrictions, directly after the introduction of GPTBot and Google-Extended crawler agents. [...] Across the entire corpora, ~1% of C4, RefinedWeb, and Dolma tokens were restricted in mid 2023, as compared to 5-7% of tokens in April 2024. Among the most critical domains (HEAD_All), 20-33% of all tokens are restricted, as compared to <3% one year prior (Figure 2a).

— §3.1 The Rise of Restrictions on Open Web Data

> AI developers are restricted at widely varying degrees. Figure 1(Lower) breaks down the restrictions by AI developers and non-profit organizations. OpenAI crawlers are restricted for 25.9% of tokens in HEAD_C4, followed by Anthropic and Common Crawl (13.3%), Google’s AI crawler (9.8%), and more distantly Cohere (4.9%), Meta (4.1%), the Internet Archive (3.2%), and lastly Google Search’s crawler (1.0%).
...
> Unrecognized crawler agents cause incorrect specifications. We find several instances where robots.txt refer to user agents that the companies do not recognize. For instance, 4.5% of websites disallowed the unrecognized user agents ANTHROPIC-AI or CLAUDE-WEB (documented as FALSE ANTHROPIC), but not the documented agent for Anthropic’s crawler, CLAUDEBOT. The origin and reason for these unrecognized agents remains unclear—Anthropic reports no ownership of these.

— §3.2 Inconsistent and Ineffective Communication on AI Consent

> The head distribution of domains is more multimodal, and heavily monetized. We observe that HEAD_All web domains are much more heavily monetized through ads (+47.5%) and paywalls (+24.1%). Accordingly, they also have significantly greater restrictions from both robots.txt (+22.5%) and Terms of Service (+35.3%). [...] Crawlers that respect the restrictions that occur far more frequently in HEAD_All will increasingly lose access to the most multi-modal, highly curated, and up-to-date content sources.

— §3.3 Correlating Features of Web Data

> For instance, in over 30% of conversations, users request creative compositions such as fictional story writing or continuation, role-playing, or poetry. However, creative writing is poorly represented among the web data used for model training. These results may provide evidence for where models trained exclusively on unstructured internet data are most “unaligned” with how real users want to use generative AI [87]. Language models trained only on web data are known to struggle to understand the structure of discourse and underperform models trained with instruction finetuning and preference training on highly curated data [124, 6, 27].

— §3.4 Misalignment between Real-world AI Usage and Web Data

> Sexual role-play appears to be a prevalent use of ChatGPT, despite being mostly removed from common public datasets. Whereas sensitive (e.g. sexual) content represents < 1% of the web domains in HEAD_C4 (see Table 4), sexual role-play represents 12% of all recorded user interactions in WildChat.

— §3.4

> However, while news websites (the mostly highly commercialized category) comprise nearly 40% of all tokens in HEAD_C4, fewer than 1% of ChatGPT queries appear to be related to news or current affairs.
...
> Recently, multiple AI developers have been accused of bypassing robots.txt opt-outs to scrape publisher websites [88, 73]. While it is not possible to confirm, in each case it appears AI systems may be distinguishing between crawling data for training, and crawling data to retrieve information for user questions at inference time. One of the few, OpenAI has two crawler agents, GPTBot for training, and ChatGPT-User for live browsing plugins (see Table 5).

— §4 Discussion

> The web needs better protocols to express intentions and consent. The REP places an immense burden on website owners to correctly anticipate all agents who may crawl their domain for undesired downstream use cases. [...] An alternative scheme might give website owners control over how their webpages are used rather than who can use them.

— §4 Discussion

> Rising expressions of non-consent will affect non-profits, archives, and academic researchers. [...] For instance, the Common Crawl is reported to be cited in 10,000+ research articles from varying fields. This tension between data creators and, predominantly, commercial AI developers has left academic and non-commercial interests as secondary victims.

— §4 Discussion

> Economic fears of AI systems may change how internet data is created and protected. The content on the internet was not created to be used for training AI models. [...] If we don’t develop better mechanisms to give website owners control over how their data is used, we should expect to see further decreases in the open web, with more websites locking their data behind login or paywalls to prevent it being trained on.

— §4 Discussion

> Consent to copy, use and train on data is a complex issue. First, the robots.txt and Terms of Service that communicate these intentions are owned by the web administrators, which are often imperfect proxies for the actual copyright holders. For instance, social media websites or forums often host content that was originally created or belongs to others.

— Impact & Ethics Statement

### Full extracted text (verbatim)
Complete `pdftotext` output of all 41 pages (page breaks removed). Preserved in full so any passage can be restored.
...
Team Leads, 2 Top Contributors, 3 Contributors (alphabetized), 4 Advisors
...
data use preferences are changing over time. We observe a proliferation of AIspecific clauses to limit use, acute differences in restrictions on AI developers, as
...
2. Consent asymmetries & inconsistencies. OpenAI’s crawlers are significantly more restricted than those of other AI developers. More broadly, preference signaling mechanisms
...
and social media sites, as compared to the many organization websites, blogs, and ecommerce websites in the long tail of web sources.
...
DATA S OURCE C RAWL DATES
W EB D OMAINS
Dolma [111]. These data sources each have
4/2019
15,928,138
100k-1M+ downloads, are the primary com- C4
R EFINEDW EB
2008 to 2/2023
33,210,738
...
derive other popular datasets [130, 118, 116]. Intersection
10,136,147
Common Crawl is released on a monthly baTable 1: Statistics on audited data sources.
...
as H EADAll . This sample represents the largest, most actively maintained, and critical domains for AI
training. For certain analyses, we consider only the head of C4, which we will refer to as H EADC4 .
We are also interested in how consent preferences have evolved within a wider sample of internet
domains. To capture this, we randomly sampled 10K domains (R ANDOM10k ) from the intersection
of the three corpora, totalling 10,136,147 domains. From the 10k sample, we selected a random
subset of 2K for human annotation (R ANDOM2k ). R ANDOM10k was sampled from the intersection of
...
Human annotations We trained annotators to manually label the websites for their content modalities (e.g. video, text); website purpose(s) (e.g. news, e-commerce); presence of paywalls and embedded advertisements; the text of the terms of service, if any; and other metadata detailed in Table 2.
Annotators received individual instructions, frequent quality calibration, and were compensated well
above industry standards at $25-$30 per hour. We collected annotations for the entirety of H EADAll
as well as from the random sample R ANDOM2k . More details on our annotation process are available
...
Measuring website administrators’ intentions A goals of our audit is to measure website administrators’ intentions for how their site can be crawled and its content used—including for training
...
Organizations in H EADC4 —the largest, most actively maintained, and critical domains for AI training.
...
settings for each of robots.txt and Terms of Service, as a portion of the Full Corpus, or H EADAll . The
...
Figure 1: A temporal analysis, from 2016 to April 2024, of the web consent signals in H EADC4 , a
sample of the largest and most critical web domains. The colored regions represent the restriction
categories as a portion of the total tokens in H EADC4 . We also use SARIMA methods to forecast trends
...
Web domains are adopting robots.txt and Terms of Service pages to signal preferences. Figure 1(Top & Middle) shows from 2016, the portion of web domains in H EADC4 without a robots.txt
...
compared to 5-7% of tokens in April 2024. Among the most critical domains (H EADAll ), 20-33% of
...
2
These values may be slightly high, especially for Terms of Service pages, due to gaps in the Wayback
Machine.
...
the H EADAll sample—the largest and most critical data sources. The robots.txt analysis (top) and
...
AI developers are restricted at widely varying degrees. Figure 1(Lower) breaks down the restrictions by AI developers and non-profit organizations. OpenAI crawlers are restricted for 25.9% of
tokens in H EADC4 , followed by Anthropic and Common Crawl (13.3%), Google’s AI crawler (9.8%),
...
Terms of Service pages have imposed more anti-crawling and now anti-AI restrictions. Figure 1(Middle) illustrates this gradual re-composition of Terms pages—with web domains shifting
...
Figure 2b shows nearly 45% of all News website tokens are fully restricted in H EADAll , as compared
...
Forecasting trends in the future suggest a continued and significant decline in open and consenting web data sources. SARIMA forecasts suggest that for just the next year (by April 2025) an
additional absolute 2-4% of C4, RefinedWeb, and Dolma tokens will be fully restricted by robots.txt.
3
For instance, see Bogard v. TikTok Inc., No. 3:23-cv-00012-RLY_MJD, 2024 WL 1588423, at ∗4 (S.D.
Ind. Mar. 24, 2024).
...
Figure 3: A cross tabulation of the Terms of Service policies and robots.txt restrictions for H EADC4 ,
...
O PENAI
91.5
we estimate the conditional probabilities of each organiC OMMON C RAWL
83.4
...
61.6
FALSE A NTHROPIC
91.5% and 83.4% of cases where any of the organizaC OHERE
52.3
...
are unaware or unable to update their robots.txt to reflect Table 3: The % each org’s crawler agents
the full list of AI developers. On the other hand, the partic- are restricted if at least one other org
ularly high omission rates of Internet Archive and Google in this pool is restricted. Gray indicates
Search suggest web administrators may be open to more crawlers with a primary purpose other
traditional crawler uses like archiving and search engines, than AI training data.
...
disallowed the unrecognized user agents ANTHROPIC - AI or C LAUDE -W EB (documented as FALSE
A NTHROPIC), but not the documented agent for Anthropic’s crawler, C LAUDE B OT. The origin and
...
+1.7 97.7±2.3 98.6±0.9 97.5±1.9
+39.8 32.9±14.2 27.0±14.7 35.4±10.6
+38.4 21.2±14.7 12.5±6.3 20.5±6.7
+0.5
0.8±1.0
0.2±0.4
1.8±3.0
...
2.6±1.2
3.0±0.7
15.1 -11.2 23.2±11.3 16.3±16.0 20.1±11.9
10.6
...
0.9±0.8
0.8±0.6
5.3 +44.7 11.5±3.9 16.8±10.8 22.9±10.9
71.2 -58.5 48.5±13.3 57.3±24.2 46.3±14.2
1.6 +10.1
5.1±4.8
5.4±8.9 14.9±8.3
4.3 +7.4
...
schemes, and sensitive content on the most well-represented web domains on the internet (H EADAll )
and on a random sample of domains (R ANDOM2k ). We also annotate the services provided and
...
and statistically significant differences between head distribution (H EADAll ) and tail distribution
(R ANDOM2k ) of web domains. H EADAll is comprised mostly of news, and social media/forums,
and encyclopedias (72.9%), in contrast to the long tail data in R ANDOM2k , which is dominated by
...
that H EADAll web domains are much more heavily monetized through ads (+47.5%) and paywalls
...
which are more common in H EADAll . This is reflected by the higher proportions of image (+4.4%),
...
Crawlers that respect the restrictions that occur far more frequently in H EADAll will increasingly lose
...
content in the webcrawls that form the bulk of AI training. For each web domain in H EADAll , we had
...
domains in H EADC4 (see Table 4), sexual role-play represents 12% of all recorded user interactions in
...
Figure 4: The most common services provided by web domains in H EADC4 do not match real
ChatGPT use cases from WildChat user logs. Left: We measure the proportion of tokens in
H EADC4 dedicated to each type of web service, and the degree to which they are monetized via
...
others; however, there is ambiguity as to whether this would cover all user requests for sexual roleplay [52]. For instance, the GPT-4 technical report makes a distinction in model refusal instructions
...
shows that a significant portion of tokens in H EADC4 are from web domains with ads, paywalls, or
both—in other words they are the most commercialized. However, while news websites (the mostly
highly commercialized category) comprise nearly 40% of all tokens in H EADC4 , fewer than 1% of
...
Emad Alghamdi, Enrico Shippole, Hamidah Oderinwale, Jianguo Zhang, Joanna Materzynska, Kevin Klyman, Kun Qian, Kush Tiwary, Lester Miranda, Manan Dey, Manuel Cherep,
...
[16] Tom Brown, Benjamin Mann, Nick Ryder, Melanie Subbiah, Jared D Kaplan, Prafulla Dhariwal, Arvind Neelakantan, Pranav Shyam, Girish Sastry, Amanda Askell, Sandhini Agarwal, Ariel Herbert-Voss, Gretchen Krueger, Tom Henighan, Rewon Child, Aditya Ramesh,
...
learners. In H. Larochelle, M. Ranzato, R. Hadsell, M.F. Balcan, and H. Lin, editors, Advances in Neural Information Processing Systems, volume 33, pages 1877–1901. Curran
...
[19] Maria Carla Calzarossa and Luisa Massari. Temporal analysis of crawling activities of commercial web robots. 10 2012. ISBN 978-1-4471-4593-6. doi: 10.1007/978-1-4471-4594-3_44.
...
[22] Isaac Caswell, Julia Kreutzer, Lisa Wang, Ahsan Wahab, Daan van Esch, Nasanbayar UlziiOrshikh, Allahsera Tapo, Nishant Subramani, Artem Sokolov, Claytone Sikasote, et al. Quality
...
generative ai, 2024.
[32] Jesse Dodge, Maarten Sap, Ana Marasović, William Agnew, Gabriel Ilharco, Dirk Groeneveld,
...
[33] Aparna Elangovan, Jiayuan He, and Karin Verspoor. Memorization vs. generalization : Quantifying data leakage in NLP performance evaluation. In Proceedings of the 16th Conference of
...
[40] Samuel Gehman, Suchin Gururangan, Maarten Sap, Yejin Choi, and Noah A Smith. Realtoxicityprompts: Evaluating neural toxic degeneration in language models. arXiv preprint
...
[47] Ben Hutchinson, Andrew Smart, Alex Hanna, Emily Denton, Christina Greer, Oddur Kjartansson, Parker Barnes, and Margaret Mitchell. Towards accountability for machine learning
...
[52] Kevin Klyman. Acceptable use policies for foundation models: Considerations for policymakers and developers. Stanford Center for Research on Foundation Models, April 2024. URL
...
Christoph Schuhmann, Huu Nguyen, and Alexander Julian Mattick. Openassistant conversations - democratizing large language model alignment. In Thirty-seventh Conference
...
[55] Julia Kreutzer, Isaac Caswell, Lisa Wang, Ahsan Wahab, Daan van Esch, Nasanbayar UlziiOrshikh, Allahsera Tapo, Nishant Subramani, Artem Sokolov, Claytone Sikasote, et al. Quality
...
[58] Shinil Kwon, Young-Gab Kim, and Sungdeok Cha. Web robot detection based on patternmatching technique. Journal of Information Science, 38(2):118–126, 2012.
[59] Hugo Laurençon, Lucile Saulnier, Thomas Wang, Christopher Akiki, Albert Villanova del
Moral, Teven Le Scao, Leandro Von Werra, Chenghao Mou, Eduardo González Ponferrada, Huu Nguyen, Jörg Frohberg, Mario Šaško, Quentin Lhoest, Angelina McMillan-Major,
Gerard Dupont, Stella Biderman, Anna Rogers, Loubna Ben allal, Francesco De Toni, Giada Pistilli, Olivier Nguyen, Somaieh Nikpoor, Maraim Masoud, Pierre Colombo, Javier
...
S. Mohamed, A. Agarwal, D. Belgrave, K. Cho, and A. Oh, editors, Advances in Neural Information Processing Systems, volume 35, pages 31809–31826. Curran Associates, Inc.,
...
Gérard Dupont, Hady Elsahar, Chris Emezue, Alham Fikri Aji, Suzana Ilić, et al. Documenting
...
[82] Hellina Hailu Nigatu and Inioluwa Deborah Raji. “i searched for a religious song in
amharic and got sexual content instead”: Investigating online harm in low-resourced languages on youtube. In Proceedings of the 2024 ACM Conference on Fairness, Accountability, and Transparency, FAccT ’24, page 141–160, New York, NY, USA, 2024. Association
...
[88] Katie Paul.
Exclusive: Multiple ai companies bypassing web standard
to scrape publisher sites, licensing firm says.
Reuters, 6 2024.
URL
...
[90] Guilherme Penedo, Quentin Malartic, Daniel Hesslow, Ruxandra Cojocaru, Alessandro Cappelli, Hamza Alobeidli, Baptiste Pannier, Ebtesam Almazrouei, and Julien Launay. The
...
[91] Guilherme Penedo, Quentin Malartic, Daniel Hesslow, Ruxandra Cojocaru, Alessandro Cappelli, Hamza Alobeidli, Baptiste Pannier, Ebtesam Almazrouei, and Julien Launay. The
...
Hailey Schoelkopf, Stella Biderman, Martin Potthast, and Jimmy Lin. Gaia search: Hugging face and pyserini interoperability for nlp training data exploration. arXiv preprint
...
impact of publicly naming biased performance results of commercial ai products. Communications of the ACM, 66(1):101–108, 2022.
...
cascades in high-stakes ai. In Proceedings of the 2021 CHI Conference on Human Factors in Computing Systems, CHI ’21, New York, NY, USA, 2021. Association for Computing Machinery. ISBN 9781450380966. doi: 10.1145/3411764.3445518. URL https:
...
[104] Teven Le Scao, Angela Fan, Christopher Akiki, Ellie Pavlick, Suzana Ilić, Daniel Hesslow,
...
[117] Hugo Touvron, Thibaut Lavril, Gautier Izacard, Xavier Martinet, Marie-Anne Lachaux, Timothée Lacroix, Baptiste Rozière, Naman Goyal, Eric Hambro, Faisal Azhar, et al. Llama: Open
and efficient foundation language models. arXiv preprint arXiv:2302.13971, 2023.
[118] Ahmet Üstün, Viraat Aryabumi, Zheng-Xin Yong, Wei-Yin Ko, Daniel D’souza, Gbemileke
Onilude, Neel Bhandari, Shivalika Singh, Hui-Lee Ooi, Amr Kayid, et al. Aya model: An instruction finetuned open-access multilingual language model. arXiv preprint arXiv:2402.07827,
2024.
...
Scientific dataset recommendation from natural language descriptions. arXiv preprint
arXiv:2305.16636, 2023.
[122] Yizhong Wang, Yeganeh Kordi, Swaroop Mishra, Alisa Liu, Noah A. Smith, Daniel Khashabi,
and Hannaneh Hajishirzi. Self-instruct: Aligning language model with self generated instructions, 2022. URL https://arxiv.org/abs/2212.10560.
...
Aditya Barua, and Colin Raffel. mt5: A massively multilingual pre-trained text-to-text transformer, 2021.
...
Yes (strong moderation) – there is content from third-parties, but it is strongly moderated/curated, either by the host, or by a review system. E.g. Wikipedia, academic journal
websites, or NYTimes, since it has a comments section, but it is carefully moderated.
Yes (weak moderation) – there is content from third-parties, that is only weakly moderated. E.g. reddit, stackoverflow, youtube, ecommerce comment/review websites, or
...
Lastly, the *A LL AGENTS * row refers to the number of total observations, as well as the tally of
...
web agents are nearly always disallowed if any AI organizations are disallowed, but the reciprocal is less frequent.
...
• Definition: the ToS specifies that only certain parts of the website are openaccess or commercially viable, while other parts are restricted. Commercial
...
Definition: the ToS does not contain any clauses or mentions regarding the prohibition or restriction of scraping or the use of data for AI or ML. Both activities are
implicitly allowed.
...
AI prohibition"}
- {"verdict": 4, "evidence": "Exact text from ToS detailing the
...
Seasonal order
(1, 1, 1, 6) - Seasonal AutoRegressive (SAR) order: 1
...
poor documentation to reproducibility, sound scientific practice, and understanding of model behavior [101, 8, 67]. Recent research has also explored the significance of documenting AI ecosystems [15]
40
...
of legal and machine learning experts, earlier research has emphasized the importance of interdisciplinary collaborations [47]. ‘Datasheets for Datasets’ [39] and ‘Data Statements’ [9] both offer
...
procedures. Crisan et al. [29] proposed interactive model cards as an alternative mode of documentation and metadata sharing. Complementary to transparency regarding the dataset creation process,
