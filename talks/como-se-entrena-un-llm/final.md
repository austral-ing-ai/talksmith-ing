...
![Pre-training y post-training en fila, con el fine-tuning como post-training a escala chica](images/sa-1-1-dos-fases-entrenamiento.png)
<!-- ascii-source:
 +----------------------+        +-------------------------------------+
...
![Reglas de limpieza de C4 y la basura que saca cada una](images/s1-2-1-reglas-limpieza-c4.png)
<!-- ascii-source:
...
![Gráfico de torta de la mezcla de datos de GPT-3](images/s1-3-1-mezcla-datos-gpt3.png)
<!-- ascii-source:
...
![Fórmula que une parámetros, tokens y cómputo, con el ejemplo de Chinchilla](images/s2-1-1-formula-computo.png)
<!-- ascii-source:
...
![Lazo de realimentación del colapso de modelos](images/s2-4-1-lazo-colapso-modelos.png)
<!-- ascii-source:
...
![El mismo prompt con tres continuaciones; solo una responde](images/s3-1-1-tres-continuaciones.png)
<!-- ascii-source:
...
![GPT-3 175B contra InstructGPT 175B con el mismo prompt (Ouyang et al., 2022, fig. 8)](images/fig-08-p015.png)
...
![Ejemplo de SFT con la pérdida enmascarada sobre el prompt](images/s4-1-1-mascara-perdida-sft.png)
<!-- ascii-source:
...
![El reward model puntúa las dos respuestas y la pérdida compara los puntajes](images/s4-4-1-perdida-reward-model.png)
<!-- ascii-source:
...
![Lazo de RLHF con PPO y la penalización KL contra el modelo SFT](images/s4-5-1-lazo-rlhf-ppo.png)
<!-- ascii-source:
        +-----------+  prompt   +----------------+
...
![La cadena de RLHF frente al atajo de DPO](images/s4-6-1-rlhf-contra-dpo.png)
<!-- ascii-source:
...
![Comandos de WebGPT y la escalera de entrenamiento](images/s5-5-1-comandos-webgpt.png)
<!-- ascii-source:
...
![Las cuatro etapas de post-training de Qwen3](images/s5-9-1-etapas-qwen3.png)
<!-- ascii-source:
...
![Grilla binaria frente a grilla con penalización por error](images/s6-2-1-grilla-penalizacion.png)
<!-- ascii-source:
...
![Memoria de un fine-tuning completo frente a la inferencia](images/s7-3-1-cuenta-memoria.png)
<!-- ascii-source:
...
![Composición de QLoRA: base cuantizada más LoRA](images/s7-5-1-composicion-qlora.png)
<!-- ascii-source:
 +---------------------------------+      +------------------------+
...
- Slide "3. Qué hay adentro" — "De esto seria bueno un piechart."
- Slide "4. Post-training: SFT y preferencias" — "SFT: Espendi el acronimo lo que significa. Revisar consistencia que esos terminos esten todos en ingles."
